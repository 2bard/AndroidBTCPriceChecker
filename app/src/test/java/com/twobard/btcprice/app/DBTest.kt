...
import com.twobard.btcprice.app.modules.storage.SharedPrefsStorage
...
class DBTest {
    ...
    @Before
    fun setUp() {
        val sharedPreferences = RuntimeEnvironment.application.getSharedPreferences("com.twobard.btcprice.app", Context.MODE_PRIVATE)
